        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light  navbar-laravel">
            <div class="container-fluid">
                ...
                <div class="navbar" id="navbarSupportedContent">
                    ...
                    <a visible="false" data-toggle="collapse" data-target="#toggle_invisible" aria-controls="toggle_invisible" aria-expanded="false" aria-label="Toggle navigation">
                    </a>
                    <div class="collapse navbar-collapse" id="toggle_invisible">
                        <a id="search_button" class="nav-link" href="#" onclick="show('search_div')" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        @guest
                        <a id="navbarDropdown_" class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 25 25" id="fwt-profile-button-loggedout" role="img" aria-labelledby="fwt-profile-button-loggedout-title">
